...
export default function Collaboration() {
  return (
    <section className="w-full px-16 my-[8%] flex">
      <div className="w-[50%] h-full flex flex-col justify-center">
        <p className="text-6xl font-semibold px-4 mb-6 text-black">
          <span className="font-bold text-lg">Our Mission</span>Transforming
          Healthcare Through Innovation and Collaboration
        </p>
