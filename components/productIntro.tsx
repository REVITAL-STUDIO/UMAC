  ...
  return (
    <section className="flex flex-col-reverse lg:flex-row  justify-between mt-[10%] xl:mt-[0%] xl:px-8">
      <div className="flex flex-col justify-center w-full lg:w-[50%] xl:px-12 px-4 my-8">
        <h1 className="text-4xl lg:text-9xl font-semibold">Our Products</h1>
        ...
        <p className="text-base xl:my-4 my-[8%]">
          From essential medical equipment to advanced wound care technology,
          our offerings are designed to support your commitment to delivering
          exceptional patient care. Partner with us for reliable service,
          trusted brands, and a comprehensive supply experience that keeps your
          facility fully equipped for every challenge.
        </p>
      </div>
